...
//asmlinkage long read_crypt(unsigned int fd, char __user *buf, size_t count);
//asmlinkage long write_crypt(unsigned int fd, const char __user *buf,
//                          size_t count);


//asmlinkage long write_crypt (int fd, const char __user * buf, size_t count);
//asmlinkage long read_crypt (int fd, const char __user * buf, size_t count);
